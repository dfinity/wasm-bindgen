...
use crate::convert::{WasmOption, WasmSlice};
...
pub unsafe fn __wbindgen_number_get(idx: u32) -> WasmOption<f64> {
...
pub unsafe fn __wbindgen_bigint_get_as_i64(idx: u32) -> WasmOption<i64> {
